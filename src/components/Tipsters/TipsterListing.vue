<template>
  <div class="tipster-list">
    <v-card v-for="tipster in tipsters" :key="tipster.id" class="mx-auto mb-3" color="white">
      ...
      <v-list-item two-line>
        ...
        <v-list-item-action class="align-self-stretch d-flex flex-column">
          ...
          <v-btn @click="handleSubscribe" small rounded class="mr-2 justify-self-center"
